  ...
  return (
    <>
      ...
      >
        ...
        {/* Left Sub Sidebar */}
        <div className="w-48 bg-gradient-to-br from-[#667EEA] to-[#764BA2] shadow-[0_8px_32px_0_rgba(102,126,234,0.30)] flex flex-col">
          {/* Header */}
                ...
                <div className="flex justify-start">
                  <div className="bg-white border border-slate-200 rounded-2xl px-4 py-3 shadow-sm">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-gradient-to-br from-[#667EEA] to-[#764BA2] rounded-full flex items-center justify-center">
