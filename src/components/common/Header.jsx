      ...
      <div className="flex w-full max-w-[1124px] flex-col lg:flex-row justify-between items-start lg:items-center gap-4 lg:gap-0">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-[13px] w-full lg:w-auto">
          ...
          <div className="flex items-center gap-[13px] order-2 sm:order-none">
            {/* Chat Toggle Button */}
            <button className="w-[72px] h-[72px] flex items-center justify-center hover:opacity-80 transition-opacity" aria-label="채팅 토글">
              <svg 
                width="73" 
                height="72" 
                viewBox="0 0 73 72" 
            ...
            {/* Settings Button */}
            <button className="flex w-[45px] h-[34px] px-[11px] py-[10px] justify-center items-center rounded-md bg-gray-200 hover:bg-gray-300 transition-colors" aria-label="설정">
            ...
            {/* Logout Button */}
            <button className="flex w-[80px] h-[34px] px-4 py-[9px] justify-center items-center rounded-md bg-[#2E86C1] hover:bg-[#2874A6] transition-colors" aria-label="로그아웃">
